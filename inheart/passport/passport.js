...
module.exports = () => {
    ...
    passport.deserializeUser((userNumber, done) => { //매 요청시 실행, passport.session() 미들웨어가 이 메서드 호출
    ...
    passport.use(
        new LocalStrategy({
            ...
            (userEmail, userPw, done) => {
                ...
                con.query("select * from user where userEmail=? and userPw=?", [userEmail, userPw], (err, result, fields) => {
